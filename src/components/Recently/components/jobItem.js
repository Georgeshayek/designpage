...
const JobItem=(props)=>{
    return(
       ...
       <button className="p-4 max-lg:p-1 max-lg:text-[12px] ease-in duration-300 text-[#00cc99] hover:bg-[#00cc99] hover:text-white bg-transparent rounded-xl flex items-center"> Apply Now <MdKeyboardArrowRight className=" w-4 h-4" /> </button>
    </div>
    )
}
