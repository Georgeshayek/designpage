...
const SignNav=()=>{
    return(
        <div className="flex justify-center items-center space-x-6 my-10 p-2  max-lg:hidden  ">
            ...
            <button className=" bg-white rounded font-semibold text-[16px] p-1 px-3 flex items-center"> <FontAwesomeIcon icon={faSignOutAlt} className="w-[20px] h-[20px] mr-1"/>create account </button>
