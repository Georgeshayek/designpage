...
const SwiperItem=(props)=>{
    return (
        ...
        <div className="flex flex-col justify-between ease-in-out duration-300 group bg-[#ffffff] p-4 max-lg:p-2 max-lg:min-w-[120px] max-lg:min-h-[140px] mr-4 max-lg:mt-4 min-h-[210px] max-h-[210px]  rounded-xl  hover:bg-[#00cc99]">
           <div>       
            {props.imageurl}
